...
public class HorarioController {
    ...
    @GetMapping("/getHorarios")  //A través de un método Post en la ruta declarada se devuelve un listado de horarios para el usuario pasado en la petición
    private ArrayList<Horario> getHorarios(@RequestParam("correo") String correo){ //Con RequestBody deserializamos un objeto Usuario a partir del cuerpo de la petición
        System.out.println("En Obtención de horarios");
        return horarioDao.getHorarios(correo);
    }

    @DeleteMapping("/eliminarHorarios")  //A través de un método Post en la ruta declarada se elimina el horario pasado en la petición
    private void eliminarHorarios(@RequestParam("correo") String correo, @RequestParam("fecha") LocalDate fecha){ //Con RequestBody deserializamos un objeto horario a partir del cuerpo de la petición
    ...
    @PutMapping("/ficharEntrada") //A través de un método Post en la ruta declarada se ficha la hora de entrada para el horario pasado en la petición
    ...
    @PutMapping("/ficharSalida") //A través de un método Post en la ruta declarada se ficha la hora de la salida para el horario pasado en la petición
    ...
    @GetMapping("/obtenerFichar") //A través de un método Post en la ruta declarada se obtienen los horario para la fecha del horario pasado en la petición
    private ArrayList<Horario> obtenerHorarioFichar (@RequestParam("correo") String correo, @RequestParam("fecha") LocalDate fecha){  //A través de un método Post en la ruta declarada se  de la salida para el horario pasado en la petición
